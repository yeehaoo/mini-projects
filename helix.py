...
Initially the project was supposed to consist of two parts, where a 3d helix would be created such that the points are equidistant in three dimensions instead of just two, but since the graphics library was not done up properly, only the first part could be completed.
"""
